...
Un falso negativo en este concepto corresponde a los trabajadores con baja satisfacción laboral. Tenemos `r table(train$Survived, train$pred_Survived)[2][1]` falsos negativos. 

Un falso positivo en este concepto corresponde a los trabajadores con alta satisfacción laboral. Tenemos `r table(train$Survived, train$pred_Survived)[3]` falsos positivos. 
